...
import { faCode, faSpinner, faArrowUpRightFromSquare } from "@fortawesome/free-solid-svg-icons";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Login failed - ensure your backend is running");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="bg-muted/30 flex min-h-screen items-center justify-center px-4 py-8">
      {/* Top bar */}
      <div className="fixed top-4 right-4 left-4 flex items-center justify-between">
        <Link
          href="/"
